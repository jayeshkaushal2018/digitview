        ...
        <div className="row">
          <div className="col-lg-7 d-flex flex-column align-items-center justify-content-center">
            ...
            <h4 style={{ paddingLeft: "100px", color: "#808080" }}>
              Our platform includes a versatile event workflow feature designed
              to help event managers capture, organize, and prioritize ideas,
              projects, and to-do lists related to event planning and execution.
            </h4>
          </div>
