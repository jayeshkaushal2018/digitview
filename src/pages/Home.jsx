                ...
                <div className='container'>
                    ...
                    <Row>
                        ...
                        <Col  xs={7} md={5}>
                            ...
                            <h1 className='mb-5 text-black fw-bold text-center text-sm-start'> <p className='text-primary' style={{'font-size': '5vw'}}>DigiView</p><p style={{"color":'#606060','font-size': '4vw' }}>Event<br/> Management <br/>Platform</p></h1>
                            {/* <MenuBtn /> */}
                            </Col>
                        {/* </div> */}
                        {/* <div className='col-sm-7 d-flex d-sm-block flex-column align-items-center' style={{"borderRadius":"8px"}}> */}
                        <Col  xs={11} md={7}>
                        <img src={HomeImg} className='img-fluid w-55' alt="about img"  style={{"mixBlendMode":"multiply","border":"none"}}/>
                        </Col>
                        {/* </div> */}
                        </Row>
                    </Container>
