...
import InPerson1 from "./../assets/leading_event_technology.jpg";
import InPerson2 from "./../assets/enable.jpg";
import InPerson3 from "./../assets/engage.jpg";
import InPerson4 from "./../assets/enhance.jpg";
import InPerson5 from "./../assets/powerful_onsite_tools_for_every_event.jpg";
      ...
      <Container className="container text-center text-md-start mt-5 pb-5">
            ...
            <CardGroup>
              <Card style={{ marginRight: "30px", border: "none" }}>
                <Card.Img
                  variant="top"
                  src={InPerson2}
                  style={{ border: "none", borderRadius: "20px" ,width:"30vh"}}
                />
                <Card.Body>
                  <Card.Title
              ...
              <Card style={{ marginRight: "30px", border: "none" }}>
                <Card.Img
                  variant="top"
                  src={InPerson3}
                  style={{ border: "none", borderRadius: "20px", width:"40vh"}}
                />
                <Card.Body>
                  <Card.Title
                    style={{ textAlign: "center", fontSize: "30px" }}
                  ...
                  <Card.Text style={{ textAlign: "center" }}>
                    Streamline attendee arrival with intuitive onsite check-in
                    for a quick and seamless experience.
                  </Card.Text>
                  <Card.Title style={{ textAlign: "center" }}>
                    Mobile experience
                  </Card.Title>
                  <Card.Text style={{ textAlign: "center" }}>
                    Create mobile apps to provide the ultimate digital
                    experience and keep attendees engaged.
                  </Card.Text>
                  <Card.Title style={{ textAlign: "center" }}>
                    Game time
                  </Card.Title>
                  <Card.Text style={{ textAlign: "center" }}>
                    Reward your most engaged attendees with points and prizes
                    for participating online and onsite.
                  </Card.Text>
                  <Card.Title style={{ textAlign: "center" }}>
                    One-to-one meetings
                  </Card.Title>
                  <Card.Text style={{ textAlign: "center" }}>
                    Set up one-to-one meetings with buyers and suppliers via
                    online portals.
                  </Card.Text>
                </Card.Body>
              </Card>
              <Card style={{ marginRight: "30px", border: "none" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text style={{ textAlign: "center" }}>
                    Give exhibitors the power to capture lead details and
                    responses to qualifying questions using the mobile app.
                  </Card.Text>
                  <Card.Title style={{ textAlign: "center" }}>
                    Session surveys
                  </Card.Title>
                  <Card.Text style={{ textAlign: "center" }}>
                    Prepare online surveys to collect feedback from your event
                    attendees and analyze your success.
                  </Card.Text>
                  <Card.Title style={{ textAlign: "center" }}>
                    Return on spend
                  </Card.Title>
                  <Card.Text style={{ textAlign: "center" }}>
                    Visualize every dollar spent against multiple financial
                    models to maximize your returns.
                  </Card.Text>
                  <Card.Title style={{ textAlign: "center" }}>
                    Custom reporting
                  </Card.Title>
                  <Card.Text style={{ textAlign: "center" }}>
                    Make smarter business decisions informed by over 120
                    included reports, or build your own.
                  </Card.Text>
                </Card.Body>
              </Card>
            </CardGroup>
        ...
        <Row style={{ marginTop: "6vw" }}>
          ...
          >
            ...
            <p style={{ textAlign: "justify", fontSize: "1.1vw" }}>
              Streamline your event check-in effortlessly with DigitView onsite
              tools. Leverage self check-in, staffed check-in, or Bluetooth
              assisted check-in to ensure a swift and hassle-free experience.
              Our tools also support beacon, QR code, and name search options,
              offering greater flexibility.
              <br />
              DigitView connects with our trusted partners to provide seamless
              name badge printing, ensuring you can manage all your check-in
              services from one centralized system.
            </p>
        ...
        <Row style={{ marginTop: "5vw" }}>
          ...
          >
            ...
            <p style={{ textAlign: "justify", fontSize: "1.1vw" }}>
              ...
              Save your precious time, so you can focus on delivering memorable
              events. We offer everything from building engaging websites and
              attendee apps, right through to customized smart registration and
              a range of portals.
            </p>
            <div style={{ textAlign: "center" }}>
              <Button variant="primary" size="lg">
